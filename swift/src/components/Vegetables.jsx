...
const Vegetables = ({ items }) => {
    ...
    return (
        <div className="grid md:ml-48  overflow-y-auto mb-10 shadow-xl backdrop-blur-lg grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 lg:ml-64 gap-4">
            {items.length === 0 ? (
                    ...
                    >
                        ...
                        {item.image && (
                            <img
                                src={item.image}
                                alt={item.name}
                                className="w-full h-[90px] md:h-[180px] lg:h-[270px] object-cover rounded-lg"
                            />
                        )}
